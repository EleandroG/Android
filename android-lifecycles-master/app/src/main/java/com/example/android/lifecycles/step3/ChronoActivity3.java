...
import com.example.android.lifecycles.step3_solution.LiveDataTimerViewModel;
    ...
    private void subscribe() {
        final Observer<Long> elapsedTimeObserver = new Observer<Long>() {
            ...
            public void onChanged(@Nullable final Long aLong) {
                String newText = com.example.android.lifecycles.step3.ChronoActivity3.this.getResources().getString(
